      ...
      <el-dialog title="添加角色"
        ...
        <span slot="footer">
          ...
          <el-button type="primary"
                     @click="comitaddroles">确 定</el-button>
        </span>
      </el-dialog>
      <!--添加角色按钮-->
      <el-row>
        ...
        <el-table-column width="60px"
          ...
          <template v-slot="scope">
            ...
            <el-row v-for="(item1,i1) in scope.row.children"
              ...
              <el-col :span="6">
                <el-tag closable
                        @close="deletedright(scope.row,item1.id)">
                  {{item1.authName}}
                </el-tag>
                <!--i用class-->
          ...
          <template v-slot="scope">
            ...
            <el-dialog title="修改角色"
              ...
              <span slot="footer">
                ...
                <el-button type="primary"
                           @click="comitalterroles">确 定</el-button>
              </span>
            </el-dialog>
            <!--分配角色权限框-->
            <el-dialog title="分配权限"
              ...
              <span slot="footer">
                ...
                <el-button type="primary"
                           @click="submitrolerightbyid">确 定</el-button>
              </span>
            </el-dialog>
            <el-button type="primary"
                       icon="el-icon-edit"
                       @click="alterroleswindow(scope.row.id)">编辑</el-button>
            <el-button type="danger"
                       icon="el-icon-delete"
                       @click="deletedrole(scope.row.id)">删除</el-button>
            <el-button type="warning"
                       icon="el-icon-s-tools"
                       @click="alterright(scope.row)">分配权限</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
