    ...
    <el-card shadow="hover" style="line-height: 35px">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="4" >
          ...
          <!--添加用户对话框-->
          <!--close对话框关闭时触发-->
          <el-dialog title="添加用户" :visible.sync="adduserdialogVisible" width="50%" @close="adddilogclosed">
              <el-form label-position="left" label-width="80px"
                       :model="addnewuser" ref="newuseraddref"
            ...
            <span slot="footer">
              ...
              <el-button type="primary" @click="subnewuser">确 定</el-button>
            </span>
          </el-dialog>
        </el-col>
      </el-row>
      ...
      <el-table :data="userlist" stripe style="width: 100%">
        ...
        <el-table-column label="状态" width="140" >
          ...
          <template v-slot="scope">
            <!--传递参数scope.row-->
            <el-switch v-model="scope.row.mg_state" active-color="#13ce66" inactive-color="#B0C4DE"
